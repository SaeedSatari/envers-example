...
class CustomerControllerTest {
    ...
    void getCustomerListSuccess() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/customers").contentType(MediaType.APPLICATION_JSON)).andExpect(status().is2xxSuccessful());
    }

    @Test
    void getCustomerListClientError() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/customer").contentType(MediaType.APPLICATION_JSON)).andExpect(status().is4xxClientError());
    }
